...
namespace Sayarah.Transactions
{
    ...
    [Table("WashTransOuts")]
    [Audited]
    public class WashTransOut : FullAuditedEntity<long>, IHasCreatorAndModeifierUserNavigation
    {
        ...
        public virtual string BeforeCarPic { get; set; }
        public virtual string AfterCarPic { get; set; }
