    ...
    var N = function(h) {
        ...
        function na(a, b, c) {
            ...
            i = {
                ...
                success: function(b) {
                    ...
                    //Modified by emaish to call error function if return has an error 
                    if (b.error) { 
                        this.error();
                        return
                    }
        ...
        function jb(a) {
            return a.bAjaxDataGet ? (a.iDraw++, B(a, !0), na(a, sb(a), function (b) {
                // Modidfied By Mohamed emaish to transform the returned object
                if (b.result)
                {
                    var modified = { aaData: b.result.aaData, iTotalRecords: b.result.iTotalRecords, iTotalDisplayRecords: b.result.iTotalDisplayRecords, draw: b.result.draw }
                    tb(a, modified)
                }
                else
                    tb(a, b);
