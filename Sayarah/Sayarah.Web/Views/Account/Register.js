(function ($) {
    ...
    $(function () {
        ...
        $.validator.addMethod("customSurname", function (value, element) {
            if (value === $registerForm.find('input[name="Name"]').val()) {
                return true;
            }
            return false;
        }, abp.localization.localize("RegisterFormSurnameInvalidMessage", "Sayarah"));
